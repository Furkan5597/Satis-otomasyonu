		...
		btnsave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!tfsifre.getText().equals(tftsifre.getText()))
				{
					...
					int cevap=JOptionPane.showConfirmDialog(null,"Deðiþiklikleri Kaydetmek Ýstiyor Musunuz ?","Satýn al",JOptionPane.YES_NO_OPTION);
					if(cevap==0)
					{
				try {					
					DBConnection conn=new DBConnection();
	                 ...
	                 { 
	                	...
	                	if(yadress.getText().length()!=0 && tfsifre.getText().length()==0 && sifre.getText().length()==0 && tftsifre.getText().length()==0 )
	                	 {
	                	...
	                	if( sifre.getText().equals(rs.getString("Kullanicisifre")) && yadress.getText().length()!=0 && tfsifre.getText().length()!=0 && tftsifre.getText().length()!=0 )
	                	{
